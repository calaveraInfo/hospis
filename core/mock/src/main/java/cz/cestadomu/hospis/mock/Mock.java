...
public enum Mock {
	CLIENT_LOGIN_REQUEST_MOCK("/mock/client/login/request.xml"), //
	CLIENT_LOGIN_RESPONSE_MOCK("/mock/client/login/response.xml"), //
	BACKEND_LOGIN_RESPONSE_MOCK("/mock/backend/login/response.xml"), //
	CLIENT_GET_VIEW_X_EMPLOYEE_REQUEST_MOCK("/mock/client/getViewX/employeesRequest.xml"), //
